	...
	render() {
		return (
	      ...
	      <div className="intro">
	        ...
	        <p>If you want to know a little more about me, you can view my <a href="https://linkedin.com/in/robinjulius" target="_blank"><i className="fa fa-linkedin"></i> Linkedin profile</a> or download my <a href="files/RobinRESUME.pdf" target="_blank"><i className="fa fa-file-text-o"></i> CV.</a> I also <a href="blog/"><i className="fa fa-rss"></i> blog</a> occasionally.</p>
